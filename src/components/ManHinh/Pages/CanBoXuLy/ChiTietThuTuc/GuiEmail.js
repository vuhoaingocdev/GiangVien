...
export const sendEmailTTHCGiangVien = ({
  ...
  let emailHtml = `
        ...
        <div>
            ...
            ${listThanhPhanHoSoHtml && `<p>2.1. Danh sách hồ sơ tiếp nhận: ${listThanhPhanHoSoHtml}`}</p>
...
export const sendEmailTTHCGV_TP_CBNV = async (
 ...
 return {
    emailHtml,subjectEmail,noiDungLyDo,
 }
};
...
export const sendEmailTTHCGV_TP_BGH = async (
 ...
 return{
  emailHtml,subjectEmail, noiDungTrinhDuyet,
 }
};
